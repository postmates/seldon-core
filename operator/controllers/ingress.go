...
type Ingress interface {
	...
	GeneratePredictorResources(mlDep *v1.SeldonDeployment,
		seldonId string,
		namespace string,
		ports []httpGrpcPorts,
		httpAllowed bool,
		grpcAllowed bool) (map[string][]runtime.Object, error)
	// Generate explainer resources
	GenerateExplainerResources(pSvcName string, p *v1.PredictorSpec,
		mlDep *v1.SeldonDeployment,
		seldonId string,
		namespace string,
		engineHttpPort int,
		engineGrpcPort int) (map[string][]runtime.Object, error)
	// Create ingress resources previously generated, returns boolean to indicate readiness
	CreateResources(resources map[string][]runtime.Object, instance *v1.SeldonDeployment, log logr.Logger) (bool, error)
...
func (d DefaultIngress) GeneratePredictorResources(_ *v1.SeldonDeployment, _ string, _ string, _ []httpGrpcPorts, _ bool, _ bool) (map[string][]runtime.Object, error) {
	return nil, nil
}

func (d DefaultIngress) GenerateExplainerResources(_ string, _ *v1.PredictorSpec, _ *v1.SeldonDeployment, _ string, _ string, _ int, _ int) (map[string][]runtime.Object, error) {
	return nil, nil
}

func (d DefaultIngress) CreateResources(_ map[string][]runtime.Object, _ *v1.SeldonDeployment, _ logr.Logger) (bool, error) {
	return true, nil
}
